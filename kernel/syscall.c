...
// LAB ch2.5 TODO: 在这里声明 sys_getpinfo 的外部函数原型。
// 格式：extern uint64 sys_getpinfo(void);
...
[SYS_settickets] sys_settickets,
  ...
  // LAB ch2.5 TODO: 在这里注册 SYS_getpinfo 到 sys_getpinfo。
  // 格式：[SYS_getpinfo] sys_getpinfo,
};
